...
#
#     rocauc_micro = roc_auc_score(y_true.cpu().detach().numpy(), y_pred.cpu().detach().numpy(), average="micro")
#     rocauc_macro = roc_auc_score(y_true.cpu().detach().numpy(), y_pred.cpu().detach().numpy(), average="macro")
#
